...
```{python}
%%entangle edjournal_event_t typing
...
```{python}
%%entangle create_edjournal_event json edjournal_event_t make_datetime
...
```{python}
%%entangle event_visitor_t event_iterator_t
...
```{python}
%%entangle event_iterator_t typing edjournal_event_t
...
#### `read_events`
```{python}
%%entangle read_events create_edjournal_event event_iterator_t syslog
...
```{python}
%%entangle read_journal syslog ntpath json read_events event_iterator_t
...
#### `track_journals`
```{python}
%%entangle track_journals event_iterator_t read_journal list_journals_sorted functools
...
```{python}
%%entangle list_journals_unsorted os
...
```{python}
%%entangle list_journals_sorted list_journals_unsorted
