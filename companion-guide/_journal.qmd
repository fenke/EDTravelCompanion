...
```{python}
%%entangle create_edjournal_event_from_logevent json edjournal_event_t make_datetime
...
```{python}
%%entangle read_journal syslog ntpath json create_edjournal_event_from_logevent event_iterator_t
...
#### `track_journals`
```{python}
%%entangle track_journals syslog event_iterator_t read_journal list_journals_sorted functools
